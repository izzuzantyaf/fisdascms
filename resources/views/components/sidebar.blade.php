<aside class="sidebar z-20 w-64 overflow-y-auto bg-gray-100 dark:bg-gray-800 flex-shrink-0 h-full absolute top-0 bottom-0 lg:relative transition ease-in-out duration-500 transform -translate-x-64 lg:translate-x-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <div class="sidebar-header flex justify-between px-4">
            <a class="text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
                Admin panel
            </a>
            <div class="back-btn cursor-pointer lg:hidden">back</div>
        </div>
