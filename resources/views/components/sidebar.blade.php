<aside class="sidebar z-20 w-64 overflow-y-auto bg-gray-100 dark:bg-gray-800 flex-shrink-0 h-full lg:mt-16 absolute transition ease-in-out duration-500 transform -translate-x-64 lg:translate-x-0">
