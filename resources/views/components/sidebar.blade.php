    ...
    <div class="py-4 pr-4 text-gray-500 dark:text-gray-400 lg:bg-white lg:rounded-lg lg:mt-8">
        ...
        <div class="menu-list mt-4">
            <?php foreach ($menu_list as [
                ...
                <a href="<?= $route ?>">
                    <div class="relative px-6 py-3 rounded-r-md inline-flex items-center w-full text-sm <?= $is_route_matched ? 'bg-blue-100 text-blue-700 hover:text-blue-700' : 'text-gray-500' ?> transition-colors duration-150 hover:text-blue-500 dark:hover:text-gray-200 dark:text-gray-100">
