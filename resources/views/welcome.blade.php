            ...
            <div class="flex items-center justify-between h-16">
              ...
              -->
                ...
                <div class="-mr-2 flex md:hidden">
                    <!-- Mobile menu button -->
                    <button class="hamburger-menu bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
