...
<div class="journal-cover flex-grow p-4 pt-8">
  ...
  <form action="/journal-cover" method="post">
    <div class="journal-cover-form-list mt-8 p-4 bg-white rounded-lg shadow-md grid grid-cols-12 gap-8">
      ...
      <?php } ?>
      <button type="submit" name="btn_journal_cover_submit" value="true" class="col-span-full sm:justify-self-end flex justify-center py-2 px-8 border border-transparent font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        Simpan
      </button>
    </div>
  </form>
