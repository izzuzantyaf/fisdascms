  ...
  <form action="/organigram" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start items-center gap-8 mt-8">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div name="cloudinary-ml" id="cloudinary-ml" class="flex justify-center py-2 px-8 font-medium rounded-md text-blue-500 border border-blue-500 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
          <input type="hidden" name="signature" class="signature" value="{{ $signature }}">
          Media library
        </div>
        <x-cloudinary-js />
      </div>
